...
<div id="sidebar-wrapper">
    ...
    <div class="sidebar-heading text-center py-4 second-text fs-4 fw-bold text-purple font_one d-flex justify-content-center align-items-center">
        HEAR APP
        </div>
    <!-- Heading -->
    ...
    <div class="sidebar-heading text-white font_one">
        <p class="small mb-0">Gesti&oacute;n de Clases</p>
    </div>
    ...
    <div class="sidebar-heading text-white font_one">
        <p class="small mb-0">Gesti&oacute;n de Campus</p>
    </div>
