...
$courseArray = General::getCourseAll();
?>
...
<div class="container-fluid px-4">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 d-flex align-items-center gap-2 font_two"><i class='bx bxs-book-bookmark me-1'></i> Gesti&oacute;n de Cursos</h1>
                    ...
                    <div class="modal-body">
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                ...
                                <label for="floatingInput">Nombre de Curso</label>
                            </div>
                        </div>
                        <div class="col-12 mb-3">
                            <div class="d-flex justify-content-between mb-2">
                                <label for="temas">Temas</label>
                                <button type="button" class="btn btn-sm btn-success" id="addTemaBtn">
                                    <i class='bx bx-plus'></i> Añadir Tema
                                </button>
                            </div>
                            <div id="temasContainer">
                                <!-- Aquí se agregarán los inputs de temas -->
                            </div>
    ...
    <div class="row">
        <?php foreach ($courseArray as $result) : ?>
            <div class="col-lg-4">
                        ...
                        <div class="widget-49 p-3">
                            <div class="widget-49-title-wrapper">
                                ...
                                <div class="widget-49-meeting-info">
                                    <span class="widget-49-pro-title"><?= $result->nombre ?></span>
                                </div>
                            </div>
                            <ol class="widget-49-meeting-points">
                                <?php
                                $temas = General::getThemeCourseId($result->id);
                                foreach ($temas as $tema) : ?>
                                    <li class="widget-49-meeting-item"><span><?= $tema->nombre ?></span></li>
                                <?php endforeach; ?>
                            </ol>
                            <div class="widget-49-meeting-action">
                                <a href="edit-courses?id=<?= $result->id ?>" class="btn btn-sm btn-warning">Editar</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        `;
            temasContainer.appendChild(newInput);
        });
    });
</script>